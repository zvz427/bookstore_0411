    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(default=1, choices=[(1, '货到付款'), (2, '微信支付'), (1, '支付宝支付'), (1, '银联支付')], verbose_name='支付方式')),
                ('status', models.SmallIntegerField(default=1, choices=[(1, '待支付'), (2, '待发货'), (3, '待收货'), (4, '待评价'), (5, '已完成')], verbose_name='订单状态')),
                ('trade_id', models.CharField(unique=True, blank=True, verbose_name='支付编号', max_length=100, null=True)),
