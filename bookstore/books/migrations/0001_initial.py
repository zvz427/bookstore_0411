    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_id', models.SmallIntegerField(choices=[(1, 'Python'), (2, 'Javascript'), (3, 'algorithms'), (4, 'machinelearning'), (5, 'operatingsystem'), (6, 'database')], default=1, verbose_name='商品种类')),
